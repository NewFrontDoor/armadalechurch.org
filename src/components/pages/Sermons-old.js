                      ...
                      <div id="node-34" className="node node-page clearfix">
                        ...
                        <div className="content">
                          <div className="field field-name-body field-type-text-with-summary field-label-hidden"><div className="field-items"><div className="field-item even">
                            <p className="minstry-text">Here you'll find all the latest talks and current sermon series we're doing at Armadale Congregational Church. Feel free to browse around and check out the different talks.
                            </p>
                            <p className="minstry-text">If you're after something specific, and can't find it here, then please <a href="/allsermons">click here</a> and you'll be able to search through all of our recorded sermons.</p></div></div></div>  </div>
